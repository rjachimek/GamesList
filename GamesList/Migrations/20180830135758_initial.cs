        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DevStatus = table.Column<string>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hltb = table.Column<int>(nullable: false),
                    Hltb100 = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Games_Devs_DeveloperID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameListModel_Games_GameID",
                        column: x => x.GameID,
                        principalTable: "Games",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameListModel_Lists_ListID",
                        column: x => x.ListID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameListModel_GameID",
                table: "GameListModel",
                column: "GameID");

            migrationBuilder.CreateIndex(
                name: "IX_GameListModel_ListID",
                table: "GameListModel",
                column: "ListID");
